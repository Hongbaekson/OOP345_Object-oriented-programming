...
template<>
int SummableLVPair<std::string, int>::s_initial_value = 0;

template<>
std::string SummableLVPair<std::string, std::string>::s_initial_value = " ";

template<typename L, typename V>
size_t SummableLVPair<L, V>::s_field_width = 0u;
